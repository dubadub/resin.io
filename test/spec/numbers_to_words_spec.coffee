...
describe 'NumbersToWords', ->
  ...
  it 'can translate 1-digit numbers', ->
      ...
      expect(@translator.translate(3)).toBe 'three'
  ...
  it 'can translate 3-digit numbers', ->
      ...
      expect(@translator.translate(211)).toBe 'two hundred and eleven'
  ...
  it 'can translate 4-digit numbers', ->
      ...
      expect(@translator.translate(1106)).toBe 'one thousand, one hundred and six'
      expect(@translator.translate(2230)).toBe 'two thousand, two hundred and thirty'
